...
func (s settings) config(onFlushError func(icelake.FlushError), onClickHouseError func(icelake.ClickHouseError)) icelake.Config {
	...
	return icelake.Config{
		ClickHouse:        mirror,
		OnClickHouseError: onClickHouseError,
